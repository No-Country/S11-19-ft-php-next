	...
	return (
		<main className="min-h-screen bg-slate-100">
			...
			<div className="flex flex-col md:flex-row-reverse md:items-center lg:justify-between">
				<Image
					src={headerPicture}
					className="w-full h-60 md:w-1/2 lg:w-2/5 lg:h-full bg-slate-200 "
					alt="header"
				/>
				<p className="mx-7 mt-6 md:mt-0 lg:w-1/3 lg:mx-32 lg:text-xl text-primary text-sm">
					<strong>Garden Wise </strong>
					es la app de <strong>cuidado de plantas</strong> que revolucionó la
					forma en que las personas cuidan y mantienen sus{" "}
					<strong>plantas</strong>
				</p>
			</div>
			<div className="mt-7 ">
				<h2 className="text-lg text-center text-secondary font-bold lg:my-14 lg:text-xl mb-4">
					Funciones
				</h2>
				{/* Carrusel */}
				<div className=" flex text-primary border-2 border-solid rounded-lg border-secondary  flex-col justify-center items-center p-2 w-52 h-56 lg:w-72 lg:h-80 ">
					<Image
						className="mt-3 w-20 h-20 lg:w-24 lg:h-24"
						src={addPlantPicture}
						alt="agregar-planta"
					/>
					<h4 className="my-3 text-primary">Agregar Planta</h4>
					<p className="text-center text-xs lg:text-sm">
						Registra y guarda información específica de una nueva planta en tu
						colección
					</p>
				</div>
				<div className=" flex text-primary border-2 border-solid rounded-lg border-secondary  flex-col justify-center items-center p-2 w-52 h-56 lg:w-72 lg:h-80">
				...
				<div className=" flex text-primary border-2 border-solid rounded-lg border-secondary  flex-col justify-center items-center p-2 w-52 h-56 lg:w-72 lg:h-80">
					...
					<p className="text-center text-xs lg:text-sm">
						Muestra tareas programadas y recordatorios de todos los cuidados
						mensuales
					</p>
				</div>
				...
				<div className="flex flex-col md:flex-row md:items-center md:justify-around md:mb-10">
					<Image
						src={landingSectionPicture}
						className="w-full md:w-1/2 lg:w-2/5 lg:h-full h-60 bg-slate-200 "
						alt="header"
					/>
				...
				<div className="bg-secondary text-slate-50 flex rounded-lg flex-col justify-center items-center p-2 w-52 h-52 lg:w-60 lg:h-60">
					<Image
						...
						src={firstAvatarCommentPic}
						alt="agregar-planta"
					/>
					<h4 className="my-3">Eduardo Gómez</h4>
					<p className="text-center text-xs ">
						¡Esta aplicación ha transformado mi habilidad para cuidar mis
						plantas!
					</p>
				</div>
				<div className="bg-secondary text-slate-50 flex rounded-lg flex-col justify-center items-center p-2 w-52 h-52 lg:w-60 lg:h-60">
